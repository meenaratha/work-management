...
<div style="max-width: 195px;"><img alt="your logo" src="{{ asset('login/assets/img/yourlogopassword.png')}}" style="display: block; height: auto; border: 0; width: 100%;" title="your logo" width="195"/></div>
</div>
</td>
</tr>
</table>
...
<td class="pad">
<div align="center" class="alignment" style="line-height:10px">
<div class="fullWidth" style="max-width: 357.5px;"><img alt="Forgot your password?" src="{{ asset('login/assets/img/lock5.png')}}" style="display: block; height: auto; border: 0; width: 100%;" title="Forgot your password?" width="357.5"/></div>
</div>
</td>
</tr>
</table>
...
<h1 style="margin: 0; color: #8412c0; direction: ltr; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 28px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 33.6px;"><strong>Forgot your password?</strong></h1>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><span style="color:#aa67cf;">We received a request to reset your password.</span></p>
<p style="margin: 0; word-break: break-word;"><span style="color:#aa67cf;">If you didn't make this request, simply ignore this email.</span></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><span style="color:#8412c0;">If you did make this request just click the button below:</span></p>
</div>
</td>
</tr>
</table>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.example.com" style="height:58px;width:225px;v-text-anchor:middle;" arcsize="0%" strokeweight="0.75pt" strokecolor="#8412c0" fillcolor="#8412c0">
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center style="color:#ffffff; font-family:Arial, sans-serif; font-size:14px">
<![endif]--><a href="{{ route('employee.reset-password', $token) }}"
style="text-decoration:none;display:inline-block;color:#ffffff;
background-color:#8412c0;border-radius:0px;width:auto;
border-top:1px solid transparent;font-weight:400;
border-right:1px solid transparent;border-bottom:1px solid transparent;
border-left:1px solid transparent;padding-top:10px;padding-bottom:10px;
font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;
font-size:14px;text-align:center;mso-border-alt:none;word-break:keep-all;"
 target="_blank"><span style="padding-left:40px;padding-right:40px;
 font-size:14px;display:inline-block;letter-spacing:normal;">
 <span style="word-break:break-word;">
    <span data-mce-style="" style="line-height: 28px;">RESET MY PASSWORD</span>
...
<p style="margin: 0; word-break: break-word;"><span style="color:#aa67cf;"><span>If you didn't request to change your brand password, </span><span>you don't have to do anything. So that's easy.</span></span></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><span style="color:#8a3b8f;">yourlogo © ·</span><span> </span><span><a href="http://[unsubscribe]/" rel="noopener" style="color: #8412c0;" target="_blank">Unsuscribe</a></span></p>
</div>
</td>
</tr>
</table>
...
<td class="pad">
<div style="color:#8412c0;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:11px;line-height:120%;text-align:center;mso-line-height-alt:13.2px;">
<p style="margin: 0; word-break: break-word;"><span><span style="color:#8a3b8f;">Your Street 12, 34567 AB City  /  info@ai-help.in / (+1) 123 456 789</span><a href="http://www.example.com" style="color: #8412c0;"></a></span></p>
</div>
</td>
</tr>
</table>
...
<table border="0" cellpadding="10" cellspacing="0" class="social_block block-6" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad">
<div align="center" class="alignment">
...
<tr>
<td style="padding:0 2px 0 2px;"><a href="https://www.facebook.com" target="_blank"><img alt="Facebook" height="32" src="{{ asset('login/assets/img/facebook2x.png')}}" style="display: block; height: auto; border: 0;" title="facebook" width="32"/></a></td>
<td style="padding:0 2px 0 2px;"><a href="https://www.twitter.com" target="_blank"><img alt="Twitter" height="32" src="{{ asset('login/assets/img/twitter2x.png')}}" style="display: block; height: auto; border: 0;" title="twitter" width="32"/></a></td>
</tr>
</table>
</div>
</td>
...
<tr>
<td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 6px;"><a href="http://designedwithbeefree.com/" style="text-decoration: none;" target="_blank"><img align="center" alt="Beefree Logo" class="icon" height="32" src="{{ asset('login/assets/img/Beefree-logo.png') }}" style="display: block; height: auto; margin: 0 auto; border: 0;" width="34"/></a></td>
<td style="font-family: 'Inter', sans-serif; font-size: 15px; font-weight: undefined; color: #1e0e4b; vertical-align: middle; letter-spacing: undefined; text-align: center;"><a href="http://poovisoft.in/" style="color: #1e0e4b; text-decoration: none;" target="_blank">Designed with meena(web developer)</a></td>
</tr>
</table>
</td>
</tr>
